...
class GroovyScriptSpecification extends spock.lang.Specification {
    ...
    def "message header"() {
        ...
        this.msg.setBody(new File("src/test/groovy/cases/example/case-1-source.msg").getText('UTF-8'))
    ...
    def "message body"() {
        ...
        then: "the body, headers and properties are correctly populated or modified"
        this.msg.getBody() == new File("src/test/groovy/cases/example/case-1-result.msg").getText('UTF-8')
    }
}